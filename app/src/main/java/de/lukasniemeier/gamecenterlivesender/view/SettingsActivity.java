...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static void startActivity(Activity from) {
        ...
        intent.putExtra( SettingsActivity.EXTRA_SHOW_FRAGMENT, SettingsActivity.LoginPreferenceFragment.class.getName() );
    ...
    protected boolean isValidFragment(String fragmentName) {
        if (LoginPreferenceFragment.class.getName().equals(fragmentName)) {
            return true;
        }
    ...
    public static class LoginPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference user = findPreference("preference_user");
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                // For list preference_login, look up the correct display value in
                ...
                // For all other preference_login, set the summary to the value's
